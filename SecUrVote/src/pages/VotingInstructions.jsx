            ...
            <div className="w-full max-w-4xl bg-white/10 backdrop-blur-md rounded-xl p-8 shadow-2xl text-white">
                ...
                <nav className="flex justify-end gap-4">
                    ...
                    <button
                        ...
                        className="px-6 py-3 text-lg font-semibold text-white bg-blue-600 rounded-full hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-all"
                    >
                        PROCEED
                    </button>
                </nav>
