...
function LoginForm() {
    ...
    const verifySecretId = async () => {
        try {
            ...
            if (response.data.status === "N") {
                ...
                //setError("You need to register first. Redirecting Automatically!");
                //alert('You need to register first. Close this box to redirect to register automatically!');
    ...
    return (
        <motion.form
            ...
            transition={{ duration: 0.5 }}
        >
            <h1 className="text-4xl font-bold mb-3 bg-gradient-to-r from-pink-500 to-purple-600 text-transparent bg-clip-text text-center">User Authorisation</h1>
            ...
            {isOpen && (
                ...
                >
                    {isLoggedIn ? (
                        ...
                        <a href="/voting-instructionss" className="block px-4 py-2 text-gray-800 hover:bg-gray-100">
