...
export function VotingHeader() {
    ...
    return (
        <div className="min-h-screen w-full bg-gradient-to-br from-purple-950 via-purple-700 to-pink-800 overflow-auto">
            <div className="max-w-[2500px] mx-auto px-30 sm:px-6 lg:px-28 py-38 flex flex-col min-h-screen">
                    ...
                    <div className="flex gap-3 mt-4 sm:mt-0 items-center">
                        ...
                        <div className="relative">
                            <motion.button
                                ...
                                className="text-lg mt-5 text-pink-200 hover:text-white transition-colors duration-300 px-4 py-3 rounded-lg bg-purple-700/50 hover:bg-purple-600/50 flex items-center gap-2"
                            >
                            ...
                            <AnimatePresence>
                                {showDropdown && (
                                    <motion.div
                                        ...
                                        animate="visible"
                                        exit="hidden"
                                        className="absolute right-0 mt-3 w-48 bg-purple-800 rounded-md shadow-lg py-1 z-10"
                                    >
                                        {isLoggedIn ? (
                                            <button
                ...
                >
                    <motion.p
                        ...
                        className="text-2xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-pink-600 to-purple-200 mb-2"
                    >
                        SSN COLLEGE OF ENGINEERING, KALAVAKKAM
                    </motion.p>
                    <motion.p
                        whileHover={{ scale: 1.1 }}
                        className="text-lg from-pink-600 to-purple-200"
                    >
                        Made with ❣ by Saipranav M, Rahul V S and Pragadish
                    </motion.p>
                </motion.footer>
            </div>
        </div>
